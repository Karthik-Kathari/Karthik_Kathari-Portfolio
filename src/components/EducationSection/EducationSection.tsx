  ...
  const education = [
    {
      ...
      icon: GraduationCap,
      details: [
        "Secured 2nd rank in the Master's Degree Program",
        "Received a Silver Medal for outstanding academic performance",
        "Built a foundation in software, systems, and technical problem solving",
        "Continues to apply academic learning to practical product engineering"
      ]
    },
    {
      degree: "Professional Certifications",
      school: "Web Development & Cybersecurity",
      year: "Ongoing",
      ...
      icon: BookOpen,
      details: [
        "Full Stack Development, MERN, HTML, CSS, and JavaScript",
        "Certified in Cybersecurity and Google Cyber Security",
        "Networking, digital forensics, ethical hacking, and cloud fundamentals",
        "Continuous learning through Microsoft, IBM, Cisco, Google, and other programs"
      ]
    }
  ];
