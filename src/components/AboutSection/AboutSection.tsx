...
const stats = [
  { icon: <Layout className="w-6 h-6" />, label: "Current Role", value: "Full Stack" },
  { icon: <Code2 className="w-6 h-6" />, label: "Featured Projects", value: "15+" },
  { icon: <Users className="w-6 h-6" />, label: "Core Focus", value: "Product" },
  { icon: <Globe2 className="w-6 h-6" />, label: "Cloud Stack", value: "AWS" },
];
        ...
        <div className="flex-1 space-y-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I am Karthik Kathari, a Full Stack Developer focused on building practical, scalable, and user-focused web applications. I work across frontend, backend, APIs, databases, and cloud infrastructure.
            </p>
          </div>
        </div>
